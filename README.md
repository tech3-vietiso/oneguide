...
Thuan Nguyen — thuanvp012van@gmail.com

## License

Phát hành theo giấy phép [MIT](LICENSE). Bạn được tự do dùng, sao chép, chỉnh sửa và tích hợp vào hệ thống của mình, chỉ cần giữ lại thông báo bản quyền và giấy phép. Phần mềm cung cấp "nguyên trạng", không kèm bảo hành.
